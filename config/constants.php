...
const STUDENT_FIRST_NAME = 0;
const STUDENT_LAST_NAME = 1;
const STUDENT_FIRSTNAME_KANA = 2;
const STUDENT_LASTNAME_KANA = 3;
const STUDENT_NICKNAME = 4;
const PASSWORD = 5;
const STUDENT_EMAIL = 6;
const SKYPE_NAME = 7;
const LANG_TYPE = 8;
const TIME_ZONE = 9;
const STUDENT_TEL = 10;
const POSTCODE = 11;
const PREFECTURE = 12;
const ADDRESS1 = 13;
const ADDRESS2 = 14;
const ADDRESS3 = 15;
const ADDRESS4 = 16;
const DEPARTMENT_NAME = 17;
const EMPLOYEE_NUMBER = 18;
const DEPARTMENT_NUMBER = 19;
const PROJECT_CODE = 20;
const COURSE_ID = 21;
const COURSE_BEGIN_MONTH = 22;
const ORDER_DATE = 23;
const START_DATE = 24;
const BEGIN_DATE = 25;
const EXPIRE_DATE = 26;
const MANAGEMENT_NUMBER = 27;
const CORPORATION_FLAG = 28;
const STUDENT_ID = 29;
const SEND_MAIL_FLAG = 30;
