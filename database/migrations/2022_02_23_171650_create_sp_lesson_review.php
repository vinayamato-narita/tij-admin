...
class CreateSpLessonReview extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        CREATE PROCEDURE `sp_update_lesson_teacher_rating`(
            ...
            IN _comment_from_student_to_office text,
            IN _comment_from_student_to_teacher text
            )
            BEGIN
    ...
    {
        Schema::dropIfExists('sp_lesson_review');
    }
}
