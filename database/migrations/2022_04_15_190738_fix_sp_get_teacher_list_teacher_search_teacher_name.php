...
class FixSpGetTeacherListTeacherSearchTeacherName extends Migration
{
    /**
     * Run the migrations.
     *
                        ...
                        ELSE
                            EXISTS (
                                SELECT * FROM lesson_schedule ls WHERE ls.teacher_id = te.teacher_id
                                    AND ls.lesson_starttime <= _date_time
                                    AND ls.lesson_endtime >= _date_time
                            )
                    END
                    AND CASE
                    ...
                    AND
                        CASE
                            ...
                            ELSE
                                ...
                                OR te.teacher_nickname LIKE CONCAT('%',_search_input, '%')
