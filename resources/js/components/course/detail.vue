                ...
                <div class="fade-in">
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row ">
                                        <label class="col-md-3 col-form-label text-md-right">コースID:
                                        </label>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-6 text-md-left p-2">
                                            ...
                                            {{this.course.display_order}}

                                        </div>
                                    </div>

                                    <div class="form-group row ">
                                        <label class="col-md-3 col-form-label text-md-right">コース名:
                                        </label>
                                        <div class="col-md-6 text-md-left p-2">
                                    ...
                                    <div class="form-group row ">
                                        <label class="col-md-3 col-form-label text-md-right">短縮名:
                                        </label>
                                        <div class="col-md-6 text-md-left p-2">

                                            {{this.course.course_name_short}}
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-6 text-md-left p-2">
                                            ...
                                            {{this.course.paypal_item_number}}
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card" v-if="this.course.course_type === 0">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <ol style="margin-left: -30px;list-style-type: none;">
                                        <li v-for="campaign in this.course.campaigns">
                                            <div class="row" style="margin: 5px 0px; padding: 5px 10px; border-bottom: 1px ridge;">
                                                <div class="col-md-3 wrap-long-text"><template v-if="!campaign.price">{{ campaign.price}}</template> <template v-else>{{ campaign.price | formatMoney}}</template> </div>
                                                <div class="col-md-7 wrap-long-text"> {{ campaign.campaign_start_time | formatDateTime}} - {{ campaign.campaign_end_time | formatDateTime}}</div>
                                                <div class="col-md-2">
                                                    <DeleteItem
    ...
    export default {
        ...
        methods: {
            ...
            getUriDeleteVideo(id, videoId) {
                return '/course/'+ id + '/video/' + videoId + '/delete';
