<template>
    <modal name="add-preparation-modal"   :pivotY="0.1" :reset="true" :width="1000" :height="auto"  :scrollable="true" :adaptive="true" :clickToClose="false" @before-open="getData" >
        <div class="card">
            <div class="card-header"> 予習一覧
                ...
                <div class="row mb-2">
                    ...
                    <div class="tanemaki-table pd-t-7" style="width: 100%;">
                        ...
                        <table v-if="dataList.length !=  0" class="table table-responsive-sm table-striped border">
                            ...
                            <tbody>
                            <tr v-for="preparation in dataList">
                                <td class="text-center">
                                    <input :value="preparation.preparation_id"  type="radio" class=" checkbox" style="width: auto; height: auto; display: inline-block;" v-model="preparationId" >
                                </td>
                                <td class="text-md-left">{{  preparation.preparation_name }}</td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            hide () {
                this.$modal.hide('add-preparation-modal');
            },
            getData(){
                let that = this;
                axios.get(this.url, {
            ...
            submit() {
                let that = this;
                axios
                    .post(that.registerUrl, {preparationId:  this.preparationId, lessonId : this.id})
                    .then(response => {
