<template>
    <modal name="teacher-add-ability-test-modal"   :pivotY="0.1" :reset="true" :width="1000" :height="auto"  :scrollable="true" :adaptive="true" :clickToClose="false" @before-open="getData" >
        <div class="card">
...
<script>
    ...
    export default {
        name: "teacher-add-ability-test-modal",
        components: {
            Loader
        },
        data() {
        ...
        methods: {
            ...
            hide () {
                this.$modal.hide('teacher-add-ability-test-modal');
            },
            getData(){
                let that = this;
                axios.get(this.url, {
