                                        ...
                                        <div class="tanemaki-table">
                                            <table class="table table-responsive-sm table-striped border">
                                                ...
                                                @foreach ($testResultList as $index => $testResult)
                                                    <tr>
                                                        <td class="text-left">{{ $testResult->student_id }}</td>
                                                        <td class="text-left">{{ $testResult->student_name }}</td>
                                                        <td class="text-left">{{ $testResult->test_name }}</td>
                                                        <td class="text-left">{{ \Carbon\Carbon::parse($testResult->test_start_time)->format('Y/m/d H:i') }}</td>
                                                        @if($testResult->comment_start_time !== null)
                                                        <td class="text-left">{{ \Carbon\Carbon::parse($testResult->comment_start_time)->format('Y/m/d H:i') }}</td>
                                                        @else
                                                            <td class="text-left"></td>
                                                        @endif

                                                        <td class="text-left">{{ $testResult->status }}</td>
