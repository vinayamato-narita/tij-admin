                                        ...
                                        <div class="tanemaki-table">
                                            <table class="table table-responsive-sm table-striped border">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center min-width-150">@sortablelink('lesson_id', ' レッスンID')</th>
                                                    <th class="text-center min-width-120">@sortablelink('is_test_lesson', ' テストあり/なし')</th>
                                                    <th class="text-center min-width-120">@sortablelink('lesson_name', ' レッスン名')</th>
                                                    <th class="text-center min-width-120">@sortablelink('lesson_description', ' 説明')</th>
                                                </tr>
                                                </thead>
                                                <tbody>
