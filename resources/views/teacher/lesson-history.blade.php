            ...
            <div class="container-fluid">
                <div class="page-heading">
                    ...
                    <div class="pull-right mrb-5">
                        @if ($adminSystem)
                            <a href="{{ route('teacher.lessonHistoryExport', $teacher->teacher_id)}}"
                               class="btn btn-primary pull-right"><i class="las la-plus"></i> CSV出力
                            </a>
                        @endif
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-5">
                                            <lesson-history-search :page-limit="{{ $pageLimit }}"
                                                                   :url="{{ json_encode(route('teacher.lessonHistory', $teacher->teacher_id)) }}"
                                                                   :data-query="{{json_encode(!empty($request) ? $request->all() : new stdClass)}}"></lesson-history-search>
                                        </div>
                                    </div>
                                    @if(!$lessonHistories->isEmpty())
                                        ...
                                        <div class="tanemaki-table">
                                            <table class="table table-responsive-sm table-striped border">
                                                <thead>
                                                <tr>
                                                    <th class="text-center width-130">@sortablelink('lesson_date',
                                                        'レッスン日')
                                                    </th>
                                                    <th class="text-center min-width-150">
                                                        @sortablelink('lesson_starttime', 'レッスン時間')
                                                    </th>
                                                    <th class="text-center min-width-150">@sortablelink('course_name',
                                                        'コース名')
                                                    </th>
                                                    <th class="text-center min-width-150">@sortablelink('lesson_name',
                                                        'レッスン名')
                                                    </th>
                                                    <th class="text-center min-width-150">
                                                        @sortablelink('lesson_text_name', 'テキスト名')
                                                    </th>
                                                    <th class="text-center min-width-150">@sortablelink('student_id',
                                                        '学習者番号')
                                                    </th>
                                                    <th class="text-center min-width-150">@sortablelink('student_name',
                                                        '学習者名')
                                                    </th>
