        ...
        <div class="container-fluid">
            <div class="page-heading">
                ...
                <div class="pull-right mrb-5">
                    <a href="{{ route('teacher.lessonHistoryExport', $teacher->teacher_id)}}" class="btn btn-primary pull-right"><i class="las la-plus"></i> CSV出力
                    </a>
                </div>
            </div>
            <div class="clear"></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-5">
                                        <lesson-history-search :page-limit="{{ $pageLimit }}" :url="{{ json_encode(route('teacher.lessonHistory', $teacher->teacher_id)) }}" :data-query="{{json_encode(!empty($request) ? $request->all() : new stdClass)}}"></lesson-history-search>
                                    </div>
                                </div>
