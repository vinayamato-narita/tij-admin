...
@section('content')
    <teacher-show
            ...
            :ability-test-list-url ="{{json_encode(route('teacher.abilityTest', $teacher->teacher_id))}}"
            :register-url ="{{json_encode(route('teacher.registerLesson',  $teacher->teacher_id))}}"
            :register-ability-test-url ="{{json_encode(route('teacher.registerAbilityTest',  $teacher->teacher_id))}}"
